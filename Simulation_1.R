###type 1 error and power : different covariance matrix between compared groups
type1error_unequal<-function(p,n1,n2,alpha,N)
{
...
power_unequal<-function(p,n1,n2,alpha,N,ss)
{
  p_value_TMECAF=rep(0,N)
  p_value_TMEC=rep(0,N)
  p_value_oracle=rep(0,N)
